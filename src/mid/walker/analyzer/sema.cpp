...
namespace RJIT::mid::analyzer {
    ...
    TypeInfoPtr SemAnalyzer::SemAnalyze(VariableDeclAST *node) {
    ...
    TypeInfoPtr SemAnalyzer::SemAnalyze(BinaryAST *node) {
    ...
    TypeInfoPtr SemAnalyzer::SemAnalyze(UnaryAST *node) {

    }

    TypeInfoPtr SemAnalyzer::SemAnalyze(ReturnAST *node) {
        std::string info;
        auto type = node->getReturn()->SemAnalyze(this);
        if (!type) return nullptr;
    ...
    TypeInfoPtr SemAnalyzer::SemAnalyze(BlockAST *node) {
    ...
    TypeInfoPtr SemAnalyzer::SemAnalyze(IfElseAST *node) {

    }

    TypeInfoPtr SemAnalyzer::SemAnalyze(CallAST *node) {
    ...
    TypeInfoPtr SemAnalyzer::SemAnalyze(WhileAST *node) {
